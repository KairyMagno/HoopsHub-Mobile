...
class DefendingPage extends StatefulWidget {
  const DefendingPage({super.key});

  @override
  _DefendingPageState createState() => _DefendingPageState();
}

class _DefendingPageState extends State<DefendingPage> {
  List<MemberInfo> members = [
    MemberInfo(
      name: 'David',
      details: 'David Robinson\nSpecialty: Defending',
      imagePath: 'images/David.avif',
      yearsOfCoaching: '6yrs',
    ),
    MemberInfo(
      name: 'Hakeem',
      details: 'Hakeem Olajuwon\nSpecialty: Defending',
      imagePath: 'images/Hakeem.webp',
      yearsOfCoaching: '12yrs',
    ),
  ];
