...
class DribblingPage extends StatefulWidget {
  const DribblingPage({super.key});

  @override
  _DribblingPageState createState() => _DribblingPageState();
}

class _DribblingPageState extends State<DribblingPage> {
  List<MemberInfo> members = [
    MemberInfo(
      name: 'Kyrie',
      details: 'Kyrie Irving\nSpecialty: Dribbling',
      imagePath: 'images/Kyrie.avif',
      yearsOfCoaching: '7yrs',
    ),
    MemberInfo(
      name: 'Pete',
      details: 'Pete Maravich\nSpecialty: Dribbling',
      imagePath: 'images/pete.avif',
      yearsOfCoaching: '10yrs',
    ),
  ];
