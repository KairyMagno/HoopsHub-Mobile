...
class PassingPage extends StatefulWidget {
  ...
  @override
  _PassingPageState createState() => _PassingPageState();
}
...
class _PassingPageState extends State<PassingPage> {
  List<MemberInfo> members = [
    MemberInfo(
      name: 'magic',
      details: 'Magic Johnson\nSpecialty: Passing',
      imagePath: 'images/magic.avif',
      yearsOfCoaching: '17yrs',
    ),
    MemberInfo(
      name: 'Larry',
      details: 'Larry Bird\nSpecialty: Passing',
      imagePath: 'images/larry.avif',
      yearsOfCoaching: '13yrs',
    ),
  ];
